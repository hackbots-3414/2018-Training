...
public class Robot extends SampleRobot {
	...
	public void DriveLeft(double left){
		System.out.println("DriveLeft enter"+ left);
		leftEncoder.reset();
		rightEncoder.reset();
		Timer.delay(0.01);
		while(left-leftEncoder.getDistance()>0){
				...
				myRobot.tankDrive(0, 0);
				System.out.println("DriveLeft exit"+ left);

	}
	public void DriveRight(double right){
		System.out.println("DriveRight enter"+ right);
		leftEncoder.reset();
		rightEncoder.reset();
		Timer.delay(0.01);
		while(right-rightEncoder.getDistance()>0){
				...
				myRobot.tankDrive(0, 0);
				System.out.println("DriveRight exit"+ right);
